...
I think the take away from this is that far more data is needed to narrow these error bars. The low end estimates are still much larger than other studies for the whole life-cycle of plastic<a href="#fn-5" class="sidenote-number"></a><span class="sidenote" id="fn-5">[Ryberg *et al*](#ryberg-2018), *Mapping of Global Plastics Value Chain*, 56, estimates 0.005% loss;<br />[Boucher and Friot](#boucher-2017), *Primary Microplastics in the Oceans*, 37, estimates 0.00033 - 0.001% loss.<br /> The low end post-upgrade estimate from [Brown *et al*](#brown-2023), "Potential for a Plastic Recycling Facility to Release Microplastic Pollution," is 0.018%</span> and the high end estimates are many orders of magnitude larger still. This study is only a single data point, but it is showing that the estimates used in other life cycle analysis may be far too small and that recycling is a much larger contributor to primary microplastics than has been accounted for.
