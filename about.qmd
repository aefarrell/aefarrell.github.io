...
Posts which use python use the [poetry-kernel](https://github.com/pathbird/poetry-kernel) to track the associated virtual environments, which are maintained in the `pyproject.toml` for each notebook. This shows the state of the virtual environment at the last time I ran the notebook.
